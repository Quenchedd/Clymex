...
<body>
  ...
  <nav>
    <ul>
    <li><button class="manage" onclick="location.href=`manage_grp.php`"><i class='bx bx-group'></i> Manage Groups</button></li>
    <li><button class="manage" onclick="location.href=`manage_act.php`"><i class='bx bx-clipboard'></i> Manage Activities</button></li>
    <li><button class="manage" onclick="location.href=`import_data.php`"><i class='bx bxs-file-import'></i> Import Data</button></li>
